...
o = {
    ...
    client_id = "YzJkNTJlMTBiZjAzZjZmMzA0Y2E1NmUxNTg3MTdlNDE4ZjU0NmE4ZWU0ZDZlYzJmMGVlMTdjMTliYzJjZTFlOA==",
    client_secret = "YzkwYmEyMzk3YjUzMmQwYjI4MDg4Zjg4ZTkwMjUwNmQ0ODFmNzU5OWJkODFiY2NjYmFlOWUyNjVhNGM5YWQyNw=="
}
...
function start_scrobble(config, data, no_osd)
    ...
    if not res then
        send_message("No internet ", 3, "0000FF")
...
mp.register_script_message("toggle-scrobble", function()
    if scrobble then
        ...
        enabled = true
        trackt_scrobble(enabled)
        send_message("Trakt scrobbling enabled", 3)
        msg.info("Trakt scrobbling enabled")
    end
end)